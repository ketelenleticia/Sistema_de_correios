...
<head>
    ...
    <title>CorreiosSpy - Criar Destinatário</title>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="p-6 max-w-3xl w-full mx-auto flex-1 flex flex-col justify-start">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-[#FFFFFF]  tracking-tight">Criar Destinatário</h1>
                ...
                <div class="bg-[#111111] rounded-2xl shadow-sm border border-[#242424]  p-6 md:p-8">
                    <form action="{{ route('destinatarios.store') }}" method="POST" class="space-y-6">
                        @csrf
