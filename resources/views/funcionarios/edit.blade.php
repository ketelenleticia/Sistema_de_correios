...
<head>
    ...
    <title>Envios - Editar Funcionário</title>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="p-6 max-w-3xl w-full mx-auto flex-1 flex flex-col justify-start">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-[#FFFFFF] mb-1">Editar Funcionário</h1>
                        <p class="text-sm text-[#A1A1AA]">Modifique os campos abaixo para atualizar as informações
                            do funcionário no sistema.</p>
                    </div>
                    <a href="{{ route('funcionarios.index') }}"
                    ...
                    <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label for="cargo" class="text-xs font-bold text-[#A1A1AA] uppercase tracking-wider">
                                    Cargo
                                </label>

                                <input type="text" name="cargo" id="cargo" value="{{ $funcionario->cargo }}" required
                                    class="w-full bg-[#111111] border border-[#242424] rounded-xl px-4 py-3 text-sm text-[#A1A1AA] placeholder:text-[#4F4F4F] focus:outline-none focus:border-orange-500 ">
                            </div>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <input type="text" name="telefone" id="telefone" value="{{ $funcionario->telefone }}"
                                    required
                                    class="w-full bg-[#111111] border border-[#242424] rounded-xl px-4 py-3 text-sm text-[#A1A1AA] placeholder:text-[#4F4F4F] focus:outline-none focus:border-orange-500 transition-colors">
                            </div>

                            <div class="md:col-span-2 flex flex-col gap-1.5">
                                <label for="email" class="text-xs font-bold text-[#A1A1AA] uppercase tracking-wider">
                                    Email
                                </label>
                        ...
                        <div class="border-t border-[#242424] pt-4 mt-6 flex justify-end">
                            <button type="submit"
                                ...
                                <i class="fa-solid fa-pen-to-square text-xs"></i> Atualizar Funcionário
                            </button>
                        </div>
                    </form>
                </div>
