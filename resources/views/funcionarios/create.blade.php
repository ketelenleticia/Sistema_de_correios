...
<head>
    ...
    <title>CorreiosSpy - Criar Funcionário</title>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="p-6 max-w-3xl w-full mx-auto flex-1 flex flex-col justify-start">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-[#FFFFFF] tracking-tight">Criar Funcionário</h1>
                        <p class="text-sm text-[#A1A1AA] mt-1">Preencha os dados abaixo para cadastrar um novo
                            funcionário
                            no sistema.</p>
                    </div>
                    <a href="{{ route('funcionarios.index') }}"
                    ...
                    <form action="{{ route('funcionarios.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <input type="text" id="cargo" name="cargo" required placeholder="Ex: Atendente"
                                    class="w-full bg-[#111111] border border-[#242424] rounded-xl px-4 py-3 text-sm text-[#A1A1AA] placeholder:text-[#4F4F4F] focus:outline-none focus:border-orange-500">
                            </div>
